      ...
      <div className="min-h-screen bg-backg text-darkblue py-20">
        <section className="max-w-6xl px-6 mx-auto md:px-12 py-16">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="mt-6 text-lg text-darkblue">
              You don't have to face this alone. These specially designed
              meditations are here to support you through difficult times,
              offering gentle guidance for anxiety, depression, and emotional
              healing.
            </p>
          </div>
        </section>
        ...
        <div className="max-w-3xl mx-auto bg-white rounded-xl shadow-md">
          <p className="text-center text-lightgreen py-4 font-semibold px-4">
            ...
            Meditation is a practise, not perfection. It's okay if your mind
            wanders. Each moment you choose to try is a moment of self-care.
          </p>
        </div>
            ...
            {practices.map((item, index) => (
              ...
              >
                ...
                <div className="p-6 flex flex-col flex-grow">
                  ...
                  <h4 className="font-semibold text-pinkGlow mb-1">
                    Benefits:
                  </h4>
